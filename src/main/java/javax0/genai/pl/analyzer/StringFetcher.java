...
public class StringFetcher {
    ...
    public static String getString(Input input) throws BadSyntax {
        return getString(input, null, true);
    }

    /**
     * Gets a string from the input with specified terminal character and comma handling.
     *
     * @param input The input to parse from
     * @param terminal The terminal character that ends the string
     * @param commaAllowed Whether commas are allowed in the string
     * @return The parsed string
     * @throws BadSyntax If there is a syntax error while parsing
     */
