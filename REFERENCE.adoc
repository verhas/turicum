...
When a single shared value is enough, prefer an atomic value (see below), where unsynchronized access is not possible at all.
====
...
Thread 1 generated 5
 prime read Thread 1 generated 7
5
 prime read 7
...
[source]
----
task1 is not ready 0task2 is ready 1
...
task1 is not ready 2
task1 is ready 5task2 is not ready 7
