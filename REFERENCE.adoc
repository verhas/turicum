...
The `object list` is  a list of expressions separated by `,` character.
At least one expression has to be present.
The value of the expression has to be a Turicum object.

The fields of the objects can be used as variables without prefixing them with any object reference.
...
[source]
----
ch.turic.commands.Closure@5b247367
6
