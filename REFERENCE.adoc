...
It is not only the command line version, but all embedding.
This helps to use the same source in any embedding on any operating system.
...
It does wrap the context of the execution, where we created the closure.

Technically functions are closures that do not wrap any other context.
...
That would violate the locality principle, not to rely on anything out of a context that may change and even less modify anything out of the context, which is in this case a loop.
...
Thread 1 generated 9
Thread 1 generated 11
 prime read 3
 prime read 5
Thread 1 generated  prime read 13
7
...
[source]
----
ch.turic.commands.Closure@70ed52de
2
...
[source]
----
ch.turic.commands.Closure@496bc455
2
...
[source]
----
ch.turic.commands.Closure@59402b8f
2
...
[source]
----
ch.turic.commands.Closure@7188af83
6
...
task2 is ready 1task1 is not ready 1
...
task2 is ready 3task1 is not ready 2
...
task1 is not ready 5task2 is not ready 3
...
task2 is not ready 3task1 is not ready 12
