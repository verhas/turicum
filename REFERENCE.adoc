...
[source]
----
Assigned value changed while calculating new value z[ch.turic.commands.StringConstant@5fb759d6]
12 already changed
----
...
exception Task stopped.
 prime read 2Thread 2 generated 3
...
task2 is not ready 4
task1 is not ready 1
task2 is not ready 5task1 is ready 8
