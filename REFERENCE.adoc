...
Thread 1 generated 13
 prime read 3
Thread 1 generated  prime read 17
5
...
.source of snippet `flow_mermaid_output`
[source]
----
let norm = command({flow test {
        a <- 3;
        b <- 4;
        a <- {
...
println("graph TD;")
let d_cells = norm.commands[0].dependentCells
...
.output of snippet `flow_mermaid_output`
[source]
----
graph TD;
    a-->a
...
[source]
----
ch.turic.commands.Closure@221a3fa4
2
...
[source]
----
ch.turic.commands.Closure@451001e5
6
...
task2 is ready 3
task1 is not ready 6task2 is not ready 0
...
task2 is not ready 2
task2 is ready 6task1 is not ready 15

task2 is not ready 0
task1 is not ready 16
task2 is not ready 1
task2 is not ready 2
...
task2 is not ready 1
task1 is not ready 20
task2 is not ready 2
task2 is ready 8
task2 is not ready 0
task1 is not ready 21
task2 is not ready 1
task1 is not ready 22
task2 is not ready 2
task1 is not ready 23
task2 is not ready 3
task1 is ready 9
task1 is not ready 0
...
`command` is a macro that will return its argument converted to a Turicum classless object without evaluation.
The command can later be used for introspection.
Since arguments can only be expressions, if you want to pass a whole command, you have to enclose it into a code block, which is a valid expression in Turicum.
...
println "before unthunk"
unthunk(z)
println "after unthunk"
