...
exception Task stopped.
 prime read 2
Thread 2 generated  prime read 3
3
...
let z = range(start=0,end=1000,closend=true)
let array = [ ..z ]
print( array[0 .. 5] + array[-5 .. array.length])
...
task2 is ready 4
task2 is not ready 0
task1 is not ready 10task2 is not ready 1

task2 is not ready 2
task1 is not ready 11
task2 is ready 5
task1 is not ready 12task2 is not ready 0
...
task2 is ready 8
task2 is not ready 0task1 is not ready 4
