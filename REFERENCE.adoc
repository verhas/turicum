...
* String literals preceeded with a `$` character are interpolated.
...
However, in more complex scenarios—especially when you try to include string literals inside the interpolated parts—it may confuse the parser. That’s why the rule exists.
...
In that case theonly remedy is the `or` operator:
...
[source]
----
ch.turic.commands.Closure@17fc391b
2
...
[source]
----
ch.turic.commands.Closure@2b30a42c
2
...
[source]
----
ch.turic.commands.Closure@609e8838
2
...
[source]
----
ch.turic.commands.Closure@359df09a
6
...
task2 is not ready 2task1 is not ready 3

task2 is ready 2
task1 is not ready 4task2 is not ready 0
...
task1 is ready 6task2 is not ready 12
...
task1 is not ready 3task2 is not ready 18

task2 is ready 8task1 is not ready 4
